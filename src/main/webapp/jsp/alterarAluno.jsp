...
<body
	...
	<div class="bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full">
		...
		<form action="ServletAluno?cmd=atualizar" method="post">
			<img class="mx-auto h-auto w-80 logo" src="images/logo.svg"
				alt="Logo" />

			<h2 class="text-2xl font-semibold text-center mb-6">
				Alterar dados do Aluno(a),
				<%=aluno.getNome()%></h2>

			<div class="mb-4">
				<label for="txtRa" class="block text-gray-300">RA:</label> <input
					type="text" id="txtRa" name="txtRa"
					class="w-full px-4 py-2 border rounded-lg bg-gray-700 text-white"
					value="<%=aluno.getRa()%>" readonly="readonly">
			</div>
			<div class="mb-4">
				<label for="txtNome" class="block text-gray-300">Nome:</label> <input
					type="text" id="txtNome" name="txtNome"
					class="w-full px-4 py-2 border rounded-lg bg-gray-700 text-white"
					value="<%=aluno.getNome()%>">
			</div>
			<div class="mb-4">
				<label for="txtEmail" class="block text-gray-300">E-mail:</label> <input
					type="text" id="txtEmail" name="txtEmail"
					class="w-full px-4 py-2 border rounded-lg bg-gray-700 text-white"
					value="<%=aluno.getEmail()%>">
			</div>
			<div class="mb-4">
				<label for="txtData" class="block text-gray-300">Nascimento
					(dd/mm/aaaa):</label> <input type="date" id="txtData" name="txtData"
					class="w-full px-4 py-2 border rounded-lg bg-gray-700 text-white"
			...
			<div class="text-center">
				<button type="submit" value="Enviar"
					class="border border-green-500 hover:bg-green-600 text-white hover:text-white font-bold py-3 px-6 rounded-lg mr-2 w-1/2 w-full">
					Enviar</button>
				<a
					...
					onclick="window.location.href = 'html/alterar.html';"> <svg
						xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
						stroke-width="2" stroke="currentColor"
						class="w-5 h-5 mr-2 svg-rotate">
